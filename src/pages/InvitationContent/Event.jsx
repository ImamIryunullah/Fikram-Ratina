  ...
  return (
    <section className="py-12 md:py-20 px-6 bg-gray-900">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Cards Container (Akad, Kapanca & Resepsi) */}
        {/* Diubah menjadi grid-cols-1 md:grid-cols-2 lg:grid-cols-3 agar memuat 3 kartu dengan rapi */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
          ...
          <motion.div
            ...
            whileInView="visible"
            viewport={{ once: true }}
            className="border border-white/10 bg-white/[0.02] backdrop-blur-sm rounded-3xl p-6 text-center flex flex-col justify-between"
          >
            <div>
              <p className="uppercase tracking-[0.3em] text-[10px] md:text-xs text-amber-400/80 mb-2 font-medium">
                ✦ Akad Nikah ✦
              </p>
              <h3 className="font-serif text-xl text-white mb-2">Sabtu</h3>

              <div className="font-serif text-5xl font-bold mb-1 bg-gradient-to-r from-amber-200 via-yellow-400 to-amber-500 bg-clip-text text-transparent drop-shadow-sm">
                04
              </div>
              <div className="font-serif text-lg text-white/80 mb-4">
                Juli 2026
              </div>
          ...
          {/* CARD 2: ACARA KAPANCA */}
          <motion.div
            variants={fadeUp}
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true }}
            className="border border-white/10 bg-white/[0.02] backdrop-blur-sm rounded-3xl p-6 text-center flex flex-col justify-between md:col-span-1"
          >
            <div>
              <p className="uppercase tracking-[0.3em] text-[10px] md:text-xs text-amber-400/80 mb-2 font-medium">
                ✦ Acara Kapanca ✦
          ...
          {/* CARD 3: RESEPSI */}
          {/* md:col-span-2 lg:col-span-1 membuat letaknya tetap estetik saat di tablet layar medium */}
          <motion.div
            variants={fadeUp}
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true }}
            className="border border-white/10 bg-white/[0.02] backdrop-blur-sm rounded-3xl p-6 text-center flex flex-col justify-between md:col-span-2 lg:col-span-1"
          >
            <div>
              <p className="uppercase tracking-[0.3em] text-[10px] md:text-xs text-amber-400/80 mb-2 font-medium">
                ✦ Resepsi ✦
              </p>
              <h3 className="font-serif text-xl text-white mb-2">Minggu</h3>
